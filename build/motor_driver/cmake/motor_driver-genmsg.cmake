...
set(MSG_I_FLAGS "-Imotor_driver:/home/river/rose_catkin_ws/src/motor_driver/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/river/rose_catkin_ws/src/motor_driver/msg/MotorSpeed.msg" NAME_WE)
add_custom_target(_motor_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "motor_driver" "/home/river/rose_catkin_ws/src/motor_driver/msg/MotorSpeed.msg" ""
)
...
_generate_msg_cpp(motor_driver
  "/home/river/rose_catkin_ws/src/motor_driver/msg/MotorSpeed.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motor_driver)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motor_driver\")")
  # install generated code
  install(
